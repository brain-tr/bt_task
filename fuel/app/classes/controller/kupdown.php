...
class Controller_Kupdown extends Controller
{
	...
	public function action_index()
	{
		...
		$data["double"]	=	db_eachpoint::get_japanese();
		...
		if($data["check"]=="1"){
			...
			$data["double"] =	db_eachpoint::on_change($hiki,$select,$h_r);
		}
 		...
 		return View::forge('kupdown',$data);
	}
}