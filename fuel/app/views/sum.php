...
//合計選択用
function goukei(total)
{
	msg = "<?php echo $msg; ?>";
	var submitType = document.createElement("input");
	submitType.setAttribute("name", "total");
	submitType.setAttribute("type", "hidden");
	submitType.setAttribute("value",msg);
	form.appendChild(submitType);
	form.method = "post";
...
<body>
<h1>科目別一覧表</h1>
<form action="sum" method="post" name="form">
<table border="1" width="600px">
	<tr>
		...
		<th><a href="" name="total" value="" onClick="goukei();return false;">合計</a></th>
